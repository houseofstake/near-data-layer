...
pub fn transform_execution_outcomes_deltas(
    changes: &mut DatabaseChanges,
    deltas: store::Deltas<DeltaProto<ExecutionOutcomeEntity>>,
) {
...
fn push_create_execution_outcome(
    ...
    changes
        .push_change("execution_outcomes", key, ordinal, DbOperation::Create)
...
fn push_delete_execution_outcome(
    changes: &mut DatabaseChanges,
    key: &str,
    ordinal: u64,
) {
    changes.push_change("execution_outcomes", key, ordinal, DbOperation::Delete);
} 