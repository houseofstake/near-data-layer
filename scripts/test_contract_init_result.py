...
def main():
    # Test with the contract initialization data from the "new" method
    # This simulates what the execution outcome result would contain
    test_result_value = {
        "config": {
            "guardians": [
    ...
    json_string = json.dumps(test_result_value)
    base64_encoded = base64.b64encode(json_string.encode('utf-8')).decode('utf-8')
    
    print("Testing contract initialization result processing...")
    ...
    print(f"Original JSON: {json.dumps(test_result_value, indent=2)}")
    ...
    try:
        ...
        # Extract specific values from the contract initialization
        ...
        print("The execution outcome result processing logic will correctly capture contract initialization data.")
        print("\nThis demonstrates that:")
        print("1. Contract initialization return values will be captured")
